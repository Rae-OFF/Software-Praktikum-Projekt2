...
public class Expedition implements Card {
	 ...
	 * Konstruktor.
	 * @param requirements
	 * 		Bekommt die Bedingung übergeben, welche man zum ausrufen erfüllen muss
	 * 		(Kombination der Karten Captain, Settler, Priest und Jack of all Trades)
	 * @param coins
	 * 		Bekommt den Wert der Karte in Goldmünzen übergeben.
	 * @param victoryPoints
	 * 		Bekommt den Wert der Karte in Siegpunkten übergeben.
	 */
	 ...
	 * @param coins
	 * 		Bekommt die Anzahl der Münzen übergeben.
	 */
	 ...
	 * @param victoryPoints
	 * 		Bekommt die Anzahl der Siegpunkte als Parameter übergeben.
	 */
